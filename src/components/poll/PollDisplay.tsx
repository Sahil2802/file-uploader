...
export const PollDisplay: React.FC<PollDisplayProps> = ({
  ...
  const { updatePollQuestion, updatePollOption } = usePolls();
            ...
            >
              ...
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  setEditingTitle(false);
                  setTitleInput(question.question);
                }}
              >
                Cancel
              </button>
            ...
            <div className="p-4 border-b border-gray-100">
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                {question.uploaded_file_url &&
                  question.uploaded_file_type?.startsWith("image/") && (
                    <div className="mb-3">
                      <img
            ...
            <div className="p-4">
              <div className="space-y-3">
                {question.options.map((option) => (
                  <div
                    key={option.id}
                    className={`cursor-pointer border border-gray-200 rounded-lg p-3 flex items-center justify-between hover:shadow-md hover:border-gray-300 transition-all duration-200 ${
                      question.user_voted &&
                    ...
                    <div className="flex-1">
                      {editingOptionId === option.id ? (
                        <form
                          onSubmit={async (e) => {
                            e.preventDefault();
                            await updatePollOption(option.id, {
                              option_text: optionInput,
                            });
                      ...
                      <div className="flex gap-2 ml-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            setOptionInput(option.option_text);
                          }}
                        >
                          <Pencil className="w-4 h-4" />
                        </button>
